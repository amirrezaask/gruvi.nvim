...
vim.api.nvim_set_hl(0, 'CursorLine', {bg='#2B2B2B', fg='none' })
...
vim.api.nvim_set_hl(0, 'NvimInvalidAssignmentWithAddition', {bg='none', fg='none' , link = "NvimInvalidAugmentedAssignment"})
vim.api.nvim_set_hl(0, 'Comment', {bg='none', fg='#B0B1B0' })
vim.api.nvim_set_hl(0, 'NvimInvalidAssignmentWithConcatenation', {bg='none', fg='none' , link = "NvimInvalidAugmentedAssignment"})
...
vim.api.nvim_set_hl(0, 'NvimInvalidIdentifierScopeDelimiter', {bg='none', fg='none' , link = "NvimInvalidIdentifier"})
...
vim.api.nvim_set_hl(0, 'BlinkCmpSignatureHelpActiveParameter', {bg='none', fg='none' , link = "LspSignatureActiveParameter"})
...
vim.api.nvim_set_hl(0, 'NvimInvalidAssignmentWithSubtraction', {bg='none', fg='none' , link = "NvimInvalidAugmentedAssignment"})
...
vim.api.nvim_set_hl(0, 'NvimInvalidOptionScopeDelimiter', {bg='none', fg='none' , link = "NvimInvalidIdentifierScopeDelimiter"})
...
vim.api.nvim_set_hl(0, 'SignColumn', {bg='#111111', fg='#404349' })
...
vim.api.nvim_set_hl(0, 'NormalFloat', {bg='#000000', fg='#FAFAFA' })
vim.api.nvim_set_hl(0, 'FloatBorder', {bg='#000000', fg='#2B2B2B' })
